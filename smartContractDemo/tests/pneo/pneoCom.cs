...
namespace smartContractDemo
{
    public class pneo_common
    {
        ...
        public static async Task<Result> api_InvokeScript(Hash160 scripthash, string methodname, params string[] subparam)
        {
            ...
            byte[] postdata;
            var url = Helper.MakeRpcUrlPost(smartContractDemo.tests.Config.api, "invokescript", out postdata, new MyJson.JsonNode_ValueString(script));
        ...
        public static async Task<string> api_SendTransaction(byte[] prikey, Hash160 schash, string methodname, params string[] subparam)
        {
            ...
            //获取地址的资产列表
            Dictionary<string, List<Utxo>> dir = await Helper.GetBalanceByAddress(smartContractDemo.tests.Config.api, address);
            ...
            byte[] postdata;
            var url = Helper.MakeRpcUrlPost(smartContractDemo.tests.Config.api, "sendrawtransaction", out postdata, new MyJson.JsonNode_ValueString(strtrandata));
