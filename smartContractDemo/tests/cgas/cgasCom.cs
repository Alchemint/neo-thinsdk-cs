...
{
    public class cgas_common
    {

        public static readonly Hash160 sc_cgas = new Hash160("0x74f2dc36a68fdc4682034178eb2220729231db76");//token 合约地址

        public static readonly string sc = "0x74f2dc36a68fdc4682034178eb2220729231db76";
